...
/obj/item/weapon/cane
	name = "Walking cane"
	desc = "A cane used for walking support by a wide variety of consumers, from the injured to the elderly. Looks like getting hit by it could really hurt."
	...
	attack_verb = list("bludgeoned", "whacked", "walloped", "thrashed")

/obj/item/weapon/dogtags
	name = "Dog tags"
	desc = "The military tags of fallen soldiers from a world the wastes have forgotten, now used as a makeshift pair of brass knuckles."
	icon = 'icons/obj/weapons.dmi'
	icon_state = "dogtags"
	item_state = "dogtags"
	force = 55
	...
	w_class = WEIGHT_CLASS_SMALL
	materials = list(MAT_METAL=50)
	attack_verb = list("beaten", "bruised", "pummeled", "thrashed")

/obj/item/weapon/longsword
	name = "Bastard sword"
	desc = "You're not sure if the sword was made out of wedlock, or if it's given the name because it is being wielded by one mean bastard."
	icon = 'icons/obj/weapons.dmi'
...
/obj/item/weapon/eldritchlongsword
	name = "Eldritch longsword"
	desc = "A piece of corrupted eldritch metal forged into a very efficient blade capable of severing steel."
	icon = 'icons/obj/weapons.dmi'
	icon_state = "eldritchsword"
	item_state = "eldritchsword"
	slot_flags = SLOT_BELT
	force = 200
	throwforce = 40
	embed_chance = 100
...
/obj/item/weapon/khopesh
	name = "Khopesh"
	desc = "A traditional Khopesh is an Egyptian sickle-sword that evolved from the battle axes of the era 1300 BC. This one appears to be forged from blue-grey steel and decorated with regal bronze metalworking."
	icon = 'icons/obj/weapons.dmi'
	icon_state = "khopesh"
	item_state = "khopesh"
	slot_flags = SLOT_BELT
...
/obj/item/weapon/johnaxe
	name = "Survival hatchet"
	desc = "A two-tone survival hatchet complete with a rubberized no-slip grip. Looks like it could hurt more if it were thrown."
	icon = 'icons/obj/weapons.dmi'
	icon_state = "johnaxe"
	item_state = "johnaxe"
	slot_flags = SLOT_BELT
	...
	w_class = WEIGHT_CLASS_NORMAL
	materials = list(MAT_METAL=50)
	attack_verb = list("whacked", "chopped", "sliced", "slashed")

/obj/item/weapon/crimsonsword
	name = "Regal sword"
	desc = "You're not sure how this weapon came to be, but it's very metals and jewels give you a very unsettling and uncomforting vibe as you hold it."
	icon = 'icons/obj/weapons.dmi'
	icon_state = "saber"
	item_state = "saber"
	slot_flags = SLOT_BELT
...
/obj/item/weapon/dracsword
	name = "Dracula's Tooth"
	desc = "A sword that once belonged to Vlad Dracula, named after his ferocious bite."
	icon = 'icons/obj/weapons.dmi'
	icon_state = "dracsword"
	item_state = "dracsword"
	...
	w_class = WEIGHT_CLASS_NORMAL
	materials = list(MAT_METAL=50)
	attack_verb = list("stabbed", "sliced", "chopped", "slashed", "pierced")
